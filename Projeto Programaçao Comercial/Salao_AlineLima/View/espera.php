    ...
    <head>
     ...
     <body>
        ...
        <?php
            ...
            $res = mysqli_query($con, "SELECT * FROM solicitacao WHERE status = 'S'");
            ...
            while($escrever=mysqli_fetch_array($res)){
                echo    "<tr><td>" . $escrever['id_solicitacao'] 
                        ...
                        . "</td><td> <a href='http://localhost/Salao_AlineLima/Controller/confirmar_atendimento.php?aceito=A&id=".$escrever["id_solicitacao"]."'><button id='aceitar'>Atendido</button></a>" 
                        . "</td></tr>";
