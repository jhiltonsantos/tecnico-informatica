...
<br>
    ...
    <form action="recebeformulario.php" method="POST">
		...
		<input type="password" name="senha" id="csenha" placeholder="*Confirmar senha" required/></br>
		</br>
		...
		<!-- <label for="numero">Nº da casa: </label> -->
            <input type="text" id="ncasa" name="numero" placeholder = "*Nº da casa" size= "7" value="<?php echo isset($_COOKIE["numero"])?$_COOKIE["numero"]:"";?>" required></br></br>
        ...
        <!-- <label for="telefone2">Telefone Opcional:</label> -->
			<input type="text" id="tel2" name="tel2" value="<?php echo isset($_COOKIE["tel2"])?$_COOKIE["tel2"]:"";?>" size= "50" maxlength="14" placeholder="Tel. Opcional                                 Ex:(86)99999-9999" onkeypress= "this.value = FormataNumero2(event)"/>
                </br></br>
		...
		<!-- <label for="dtnas">Data de nascimento: </label> -->
			...
			<input type="radio" value="F" name="sexo">Feminino</input></br>
			</br>
