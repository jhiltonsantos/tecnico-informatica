...
<div class="ul">
  ...
  <h2>Verificação de Pagamento</h2>
    <p>Pagamento Deve Ser Realizado Até 72 horas Depois da Compra</p>

  <p>Contato Para Reclamação -  (86)6666-6666</p>
  ...
  <table class="w3-table-all">
    ...
    $procurasorteio = mysqli_query($conect, "Select * from sorteio where usuario = '".$user."';");
    ...
    if($contasorteio>0){
        while ($arraysorteio = mysqli_fetch_array($procurasorteio)){
            ...
            . '<td>'.$user.'</td>'
                    ...
                    . '<td>'.$arraysorteio['hora_pagamento'].'</td></tr></table>';
        }
    }else{
